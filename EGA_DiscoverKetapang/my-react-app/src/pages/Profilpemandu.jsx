            ...
            <Carousel interval={null} pause={false}>
              <Carousel.Item className=" ">
                <div className="carousel-row d-flex justify-content-center align-items-center ">
                  <div className="carousel-element  ">
                    "Kami sangat beruntung memilih Nur sebagai tour guide kami
                    selama liburan kami di Ketapang. Dia juga sangat ramah
                    dan suka membantu.
                  </div>
                  <div className="carousel-element">
                    {" "}
                    "Terima kasih, Nur, atas pengalaman wisata yang luar biasa!
                    Nur mampu menjawab semua pertanyaan kami dan membuat
                    liburan kami di Ketapang menjadi tak terlupakan."
                  </div>
                  <div className="carousel-element">
                    {" "}
                    "Kami sangat beruntung memilih Nur sebagai pemandu wisata
              ...
              <Carousel.Item>
                <div className="carousel-row ">
                  <div className="carousel-element">
                    "Nur adalah pemandu wisata yang luar biasa. Ia membuat
                    perjalanan kami menjadi lebih informatif dan menyenangkan.
                    Terima kasih atas pengalaman yang tak terlupakan, Nur!"
                  </div>
                  <div className="carousel-element">
                    {" "}
                    "Kunjungan kami ke Ketapang menjadi lebih berkesan
                    berkat Nur. Nur tidak hanya ahli dalam sejarah dan
                    destinasi, tapi juga sangat ramah dan responsif."
                  </div>
                  <div className="carousel-element">
                    {" "}
                    "Nur adalah pemandu terbaik yang kami temui. Dia
                    menjelaskan sejarah dan destinasi kami dengan detail dan
                    gairah. Kami merasa sangat puas dengan panduan Nur."
                  </div>
                </div>
              </Carousel.Item>
            </Carousel>
